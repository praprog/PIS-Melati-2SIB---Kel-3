<!-- resources/views/riwayat_medis/create.blade.php -->
...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>Tambah Riwayat Medis Baru</h2>
                @if($errors->any())
                ...
                @endif
                <form action="{{ route('riwayat_medis.store') }}" method="POST">
                    @csrf
...
<head>
    ...
    <title>Tambah Data Riwayat Medis - Penerimaan Mahasiswa Baru</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('riwayat_medis.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
            ...
            <div class="card card-warning">
                ...
                <form action="{{ route('riwayat_medis.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="font-weight-bold">Keterangan</label>
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" rows="5" placeholder="Masukkan Keterangan"></textarea>
                            <!-- error message untuk keterangan -->
                            @error('keterangan')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                        ...
                        <div class="form-group">
                            <label class="font-weight-bold">NIS</label>
                            <input type="number" class="form-control @error('NIS') is-invalid @enderror" name="NIS" placeholder="Masukkan NIS">
                            <!-- error message untuk NIS -->
                            @error('NIS')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
