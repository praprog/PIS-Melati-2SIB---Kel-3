        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('kehadiran.update',

$data->id_kehadiran) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
...
mt-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_kehadiran') is-invalid @enderror"
                                    ...
                                    kehadiran" value="{{ $data->tanggal_kehadiran }}">
