                        ...
                        <form action="{{ route('siswa.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_murid') is-invalid @enderror"
                                    name="nama_murid" placeholder="Nama siswa">
                                @error('nama_murid')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                    name="alamat" placeholder="Alamat siswa">
                                @error('alamat')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Data Khusus Murid</label>
                                <input type="text" class="form-control @error('data_khusus_murid') is-invalid @enderror"
                                    name="data_khusus_murid" placeholder="data_khusus_murid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('riwayat_medis_murid') is-invalid @enderror"
                                    name="riwayat_medis_murid" placeholder="riwayat_medis_murid">
                    ...
                    <form action="{{ route('siswa.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_murid') is-invalid @enderror"
                                    name="nama_murid" placeholder="Nama Murid">
                                @error('nama_murid')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
